...
const currentWeatherBuilder = (currentWeather) => {
  ...
  stringToPrint +=       `<a href="#" id='five-day' class="btn btn-primary col-md-4" role="button">5 Day Forecast</a><a class="btn btn-primary save-me col-md-4 col-md-offset-4" role="button">Save Forecast</a>`;
  stringToPrint +=     `</div>`;
  stringToPrint +=   `</div>`;
  stringToPrint += `</div>`;
  stringToPrint += `</div>`;
